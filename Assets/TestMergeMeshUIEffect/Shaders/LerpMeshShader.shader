Shader "UI/LerpMeshShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void UnpackParamEff(float input, out half4 color1, out half4 color2, out half4 color3)
            {
                int index = round(input % 100);
                color3 = _TileColors[index];
                input /= 100;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                half isEnable;
                UnpackParamEff(i.paramEff, color1, color2, color3);
                ...
                // resultColor = isEnable * resultColor + (1-isEnable) * (resultColor * (1 - _DisableColor.a) + _DisableColor * _DisableColor.a);
